...
def filter_for_phase(
    ...
    selected_phase = selected_phase.sort_values([ppid_col, 'target_x_label', 'phase', 'trial_num_target'])
    ...
    if inc_phase == True:
        ...
        selected_phase['phase_trial_target'] = selected_phase.groupby([ppid_col, 'target_x_label']).cumcount() + 1
    ...
    selected_max_df = (
        selected_phase
        .groupby([ppid_col, 'target_x_label'], observed=True)['phase_trial_target']
        .max()
